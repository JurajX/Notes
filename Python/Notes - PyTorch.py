...
my_tensor.OPERATION()           # functional operation
my_tensor.OPERATION_()          # in place operation
...
t.reshape(X,Y,...)          # reshapes the tensor to X,Y,...-dim tensor
